...
export default function PlantUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setDetailsURL(cleanValues.detailsURL);
    setDescription(cleanValues.description);
    setLastWatered(cleanValues.lastWatered);
    setNextWater(cleanValues.nextWater);
    setBelongsTo(cleanValues.belongsTo);
    setFirstNotificationSentAt(cleanValues.firstNotificationSentAt);
    setWaterIntervalDays(cleanValues.waterIntervalDays);
    setErrors({});
  };
